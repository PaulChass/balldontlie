				...
				if ( $is_shortcode === false ) {
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center hestia-testimonials-title-area">
							...
							echo '<h4>balldontlie.fr</h4><a href="https://balldontlie.fr/"><div class="row"><img src="https://balldontlie.fr/screenshot.png"/></a>
							<h6> Plateforme  pour les passionnés de basket et parieurs NBA</h6>
							<ul style="list-style-type: none">Projet perso réalisé avec : 
								<li> PHP / JavaScript(JSX) / SQL  </li><li>Frameworks :  Symfony et React </li>
								<li>Base de données: mySQL</li><li>Gestionnaire de paquets: yarn</li>
							</ul></div>';
							echo '<h4 style="margin-top:50px">Calculateurs médicaux</h4>
							<div class="row"><img src="https://balldontlie.fr/cardio.png"/>
							<h6> Automatisation et calculateur de résultats médiacaux</h6>
							<ul style="list-style-type: none">Mission freelance réalisé avec : 
								<li> PHP / JSON / XML / HTML / Javascript  </li><li>Frameworks : PHP natif </li>
								<li>Base de données: postgreSQL</li><li>Librairies: Bootstrap / jQuery</li>
							</ul></div>
							';
		...
		if ( ! empty( $hestia_testimonials_content ) ) {
			...
			foreach ( $hestia_testimonials_content as $testimonial_item ) :
				...
				<div class="col-xs-12 col-ms-6 col-sm-6 <?php echo apply_filters( 'hestia_testimonials_per_row_class', 'col-md-4' ); ?>">
					<div class="card card-testimonial card-plain" style="display:none" <?php echo hestia_add_animationation( 'fade-right' ); ?>>
						<?php
						if ( ! empty( $image ) ) :
							/**
