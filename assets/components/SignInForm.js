...
function SignInForm(props) {
    ...
    const handleChange = (e) => {
      ...
      return(
        <div id="signin" className='w-50 mx-auto bg-dark text-white justify-content-center align-items-center m-3 p-5'   style={{opacity:0.8,borderRadius:"1rem",display: props.showSignIn?  "block" :  "none" }}>
