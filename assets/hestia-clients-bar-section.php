		...
		<section class="hestia-clients-bar text-center <?php echo esc_attr( $wrapper_class ); ?>" id="clients" data-sorder="hestia_clients_bar" <?php echo wp_kses_post( $section_style ); ?>>
			...
			<div class="container">
				...
				<ul class="clients-bar-wrapper" <?php echo hestia_add_animationation( 'fade-up' ); ?>>
					<?php
					echo '<div class="card card-testimonial card-plain">
							<div class="card-avatar">
							<img class="img" src="https://media.licdn.com/dms/image/C5603AQH7JTo8qncffQ/profile-displayphoto-shrink_100_100/0/1516326486355?e=1711584000&amp;v=beta&amp;t=H9Z8ywTGzWjRnGiiE7YckjrWqp-Q5zCroZTL83yNLSA" alt=" Frédéric Baer " title=" Frédéric Baer ">
						  </div>
						  <h4 class="card-title"> Frédéric Baer </h4>
						  <h6>VAR for pro 3D printers and tech consumables</h6>
						  <p class="card-description"><q>En tant que donneur d\'ordre, j\'apprécie beaucoup le travail de Paul. Il est pragmatique et possède un très bon bagage technique.</q></p>
						  </div>';
