...
function StatGraph(props) {
	...
	useEffect(() => {
		...
		return (
			<div id="playerGraph" style={{opacity:"0.6",borderRadius:"1rem"}}> 
			{isLoaded && <i class="fa fa-window-close" aria-hidden="true" style={{position:"relative",left:"94%",top:"3rem",zIndex:"1",fontSize:"3rem"}} 
			onClick={()=>hide()}></i>} 
			{options !== 0 && 
