...
<div className="collapse navbar-collapse" id="navbarNav">
  <ul className="navbar-nav">
    ...
    <li className={props.menuItem == 0 ? 'nav-item active' : 'nav-item' }>
      <a className="nav-link" onClick={()=>props.setMenuItem(0)}>Paris Disponibles
</a>
    </li>
    ...
    <li className={props.menuItem == 3 ? 'nav-item active' : 'nav-item' }>
      <a className="nav-link" onClick={()=>props.setMenuItem(3)}>Miser sur un Vainqueur
</a>
    </li>
    <li className={props.menuItem == 4 ? 'nav-item active' : 'nav-item' }>
      <a className="nav-link" onClick={()=>props.setMenuItem(4)}>Miser sur un Joueur</a>
    </li>
  </ul>
</div>
<div className="navbar-text">
  ...
  <span className="user-info"><SignIn teams={props.teams} gameNumber={props.gameNumber} gameId={props.gameId} registered={props.registered} setRegistered={props.setRegistered} user={props.user} hTeamName={props.hTeamName} aTeamName={props.aTeamName} setMenuItem={props.setMenuItem} menuItem={props.menuItem} />
</span>
</div>
</nav>
